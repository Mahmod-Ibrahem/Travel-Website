...
@section('content')
    <div class="h-[20rem] md:h-screen w-full ">
        <div
            ...
            style="background-image: url('{{ asset('Images/Safari.jpg') }}'); background-size: cover; background-repeat: no-repeat; background-position: center;">
    ...
    @component('components.Sections.SafariTours',['tours'=>$tours])@endcomponent
@endsection
