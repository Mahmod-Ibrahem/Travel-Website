<div class="flex justify-around items-center py-1">
    ...
    <div class="hidden md:block  md:h-[4.5rem] ">
        <img src="{{ asset('/Images/Logo.webp') }}" alt="logo" width="140" height="72"
    ...
    <div class="hidden md:flex items-center gap-7  font-medium text-lg ">
        <div class="nav_anch_div">
            <a href="{{ route('home') }}"
                class="nav_anch_p active:text-main    @if (Route::currentRouteName() == 'home') text-main @endif">
                <p>HOME</p>
            </a>
        </div>
        <div class="nav_anch_div">
            <a href="{{ route('day-tours.index') }}" class="nav_anch_p">
                <p>DAY TOURS</p>
            </a>
        </div>

        <div class="nav_anch_div">
            <a href="{{ route('tour-packages.index') }}" class="nav_anch_p ">
                <p>TOUR PACKAGES</p>
            </a>

        </div>
        <div class="nav_anch_div">
            <a href="{{ route('Blog.index') }}" class="nav_anch_p">
                <p>BLOG</p>
            </a>
        </div>

        <div class="nav_anch_div">
            <a href="{{ route('contact.index') }}" class="nav_anch_p">
                <p>CONTACT</p>
            </a>
        </div>

        <div class="nav_anch_div">
            <a href="{{ route('about') }}" class="nav_anch_p">
                <p>ABOUT US</p>
            </a>
        </div>
...
<div id="menu" class="absolute z-10 bottom-0 w-screen hidden  ">
    <!-- Text overlay -->
    <ul class=" flex flex-col font-bold text-sm  lg:hidden   tracking-wide gap-2 p-3
        bg-white">
        <a href="{{ route('home') }}" class="nav_anch_p">{{ __('Home') }}</a>
        <p class="border-b border-gray-300 "></p>
        <a href="{{ route('day-tours.index') }}" class="nav_anch_p">{{ __('Day Tours') }}</a>
        <p class="border-b border-gray-300 "></p>
        <a href="{{ route('tour-packages.index') }}" class="nav_anch_p">{{ __('Tour Packages') }}</a>
        <p class="border-b border-gray-300 "></p>
