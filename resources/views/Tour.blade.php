...
{{asset('Images/hero-bg.jpg')}}">
        ...
        <div class="flex gap-2 md:mt-4 items-center py-6">
            <p class="text-lg md:text-2xl font-medium text-[#333] ">{{$tour->locations}}</p>
            <svg class="h-5 w-5 md:h-8 md:w-8 text-[#ff6700]" fill="none" viewBox="0 0 24 24"
                 stroke="currentColor">
            ...
            <div class="flex flex-col md:w-[45rem]  md:mx-0 mx-auto  ">
                <div id="Holder" class="relative ">
                    <div id="images_container"
                        ...
                        <svg id="prev"
                             class="text-[#ff6700] hover:text-white  previous w-9 h-9 text-center rounded-full"
                        ...
                        <svg id="next" class="next w-9 h-9 text-[#ff6700] hover:text-white text-center rounded-full"
                             viewBox="0 0 24 24" fill="none" stroke="currentColor"
                             stroke-width="2"
                             stroke-linecap="round" stroke-linejoin="round">
                            <circle cx="12" cy="12" r="10"/>
                ...
                <div id="tabContainer" class="w-full mt-6">
                    <div class="w-full">
                        <div
                            class="mb-4 flex space-x-1 p-[10px] md:p-2  bg-white   rounded-lg shadow text-Primary border-l-[#ff6700] border-l-[3px]">
                        ...
                        <div id="tabContent_Places"
                            ...
                            @foreach (explode('/', $tour->places) as $places)
                                <div class="flex justify-between gap-4 h-fit mt-2">
                                    ...
                                    <svg class="h-6 w-6 text-[#ff6700]" width="24" height="24"
                                         viewBox="0 0 24 24"
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function openTab(tabIndex) {
            ...
            document.querySelectorAll('[id^="tab_"]').forEach(function (button) {
                button.classList.remove("text-[#ff6700]");
            });

            // Show the selected tab content
            document.getElementById(tabContentIds[tabIndex - 1]).style.display = "inline-block";

            document.getElementById("tab_" + tabIndex).classList.add("text-[#ff6700]");
        }
