...
@section('content')
    ...
    <div class="parent_container max-w-7xl mx-auto py-6">
        <div class="flex flex-col justify-center items-center     overflow-hidden w-full">
            <p class="destination_p">Luxor is a city located on the eastern bank of the Nile River in southern Egypt. It
                is
                ...
                Valley of the Kings and the Valley of the Queens on the west bank of the river.Luxor is distinguished as
                the
                city that has most of its effects in the open air, where you can see it while you are touring the great
                city
            ...
            <p class="destination_p">
                Temple of Karnak:It is important to Egypt's cultural history because it was a place of worship and
                provides
                clues about ancient Egyptian religion.It was built as a temple dedicated to worshiping the gods. Being
                the
                largest building for religious purposes ever constructed, it is the most chosen and privileged place by
                the
                ancient Egyptians.
            </p>
            ...
            <p class="destination_p">
                Ramesses II, better known as Ramesses the Great, was an ancient Egyptian pharaoh who was the third ruler
                of
                the Nineteenth Dynasty. This temple was built and contains the tomb of King Ramesses.The temple's
                interior
            ...
            <p class="destination_p">
                Luxor Temple is a large ancient Egyptian temple complex located on the eastern bank of the Nile River in
                the
            ...
            <p class="destination_p">
                The valley became a royal cemetery for the great pharaohs such as Tutankhamun, Seti I and Ramesses II,
                in
                addition to queens and high priests. The temple is considered a unique tourist attraction in terms of
                luxury
                and greatness of the building and construction in the ancient era and its distinction in that it
                includes
            ...
            <p class="destination_p">
                ...
                located opposite the city of Luxor, and is considered one of the masterpieces of ancient architecture.
                It
                has a sloping facade and has a series of ancient terraces. Its walls are decorated with carvings
                depicting
