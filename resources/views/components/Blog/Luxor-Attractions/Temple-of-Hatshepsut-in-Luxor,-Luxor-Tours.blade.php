@extends('layouts')
@section('title')
    Explore the Temple of Hatshepsut | Ancient Egyptian Landmark
@endsection
@section('description')
    Join Desert Storm Egypt Tours to explore the Temple of Hatshepsut. Discover the rich history and stunning architecture of this iconic Egyptian site.
@endsection
@section('content')
    <div class="h-[20rem] md:h-screen w-full ">
        <div
            class="md:bg-fixed h-full w-full object-cover bg-center bg-cover"
            style="background-image: url('{{ asset('Images/Blog/Luxor/Hatshebsut/1.webp') }}'); background-size: cover; background-repeat: no-repeat; background-position: center;">
