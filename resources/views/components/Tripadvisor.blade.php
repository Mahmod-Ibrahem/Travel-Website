        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <div class="flex justify-center gap-0.5 text-green-500">
                    <svg class="w-4 h-4 text-[#ff6700] me-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                ...
                <p class="mt-0.5 text-lg font-medium text-gray-900">{{$review_name}}</p>
            </div>
        </div>
