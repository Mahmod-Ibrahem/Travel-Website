    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div
            ...
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                <a href="https://pagedone.io/" class="flex justify-center lg:justify-start mb-6">
                    <div class="hidden md:block">
                        <img src="{{ asset('/Images/logo.png') }}" alt="logo" width="140" height="72"
                            class="w-[7rem] md:w-[8rem] h-18 object-cover">
                    </div>
                </a>
                <div class="flex flex-col md:flex-row items-start md:space-y-8  mt-3 md:mt-0 text-Primary font-medium">
                    <!-- Item 1 -->
                    <div class="h-10 group space-y-2">

                        <span class="flex    pb-2">
                            <svg class="h-6 w-6 text-link-color" width="24" height="24" viewBox="0 0 24 24"
            ...
            <div class="lg:mx-auto text-left ">
                ...
                <ul class="text-sm  transition-all duration-500">
                    <li class="footer_anchor"><a href="{{ route('day-tours.index') }}">Day Tours</a></li>

                    <li class="footer_anchor"><a href="{{ route('tour-packages.index') }}">Tour Packages</a></li>
                </ul>
            </div>
        </div>
        <!--Grid-->
                ...
                <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                    ...
                    <a href="javascript:;"
                        ...
                        <svg class="w-[1.25rem] h-[2rem]" fill="#000000" version="1.1" id="Capa_1"
                            ...
                            viewBox="0 0 98.566 98.566" xml:space="preserve" stroke="#00af87">
                            ...
                            <g id="SVGRepo_iconCarrier">
                                <g>
                                    <g>
                                        ...
                                        <path
                                            d="M24.417,41.311c6.731-0.007,12.194,5.429,12.177,12.156c-0.019,6.809-5.386,11.916-11.601,12.199 c-7.093,0.324-12.816-5.33-12.803-12.195C12.204,46.516,17.936,41.195,24.417,41.311z M32.352,53.457 c-0.013-4.417-3.585-7.938-8.044-7.93c-4.301,0.008-7.905,3.638-7.895,7.955c0.011,4.367,3.611,7.958,7.992,7.97 C28.759,61.462,32.363,57.836,32.352,53.457z">
                                        </path>
                                        <path
                                            d="M73.828,49.443c2.232-0.002,4.062,1.829,4.041,4.048c-0.022,2.224-1.821,4.026-4.016,4.027 c-2.26,0-4.077-1.786-4.072-3.999C69.785,51.223,71.55,49.445,73.828,49.443z">
                                        </path>
                                        <path
                                            d="M24.396,49.407c2.266-0.002,4.087,1.808,4.096,4.067c0.009,2.24-1.829,4.079-4.084,4.084 c-2.309,0.005-4.09-1.779-4.088-4.1C20.32,51.179,22.097,49.41,24.396,49.407z">
                                        </path>
                                    </g>
                                </g>
                            </g>
                    ...
                    <a
                        class="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#010101]  hover:bg-gray-900 cursor-pointer ">
