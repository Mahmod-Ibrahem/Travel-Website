<div
    ...
    <a href="{{ route($Category['type'] . '.view', $Category['slug']) }}">
        ...
        <img class="group-hover:scale-110 transition-all duration-[2s] ease-out w-full h-full object-fill"
            src="{{ $Category['image'] }}" alt="Product Image" />
        <div class="absolute bottom-[10%] left-1/2 transform -translate-x-1/2 w-full flex flex-col items-center">
            <h3 class="text-[22px] text-white font-medium text-center uppercase tracking-wide ">{{ $Category['name'] }}
            </h3>
            <h3 class="text-[14px] text-white font-medium text-center uppercase tracking-wide ">
