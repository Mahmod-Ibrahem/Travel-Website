    ...
    <div class="parent_container max-w-7xl mx-auto">
        ...
        <div id="Testimonials_Cards"
            ...
            @foreach ($reviews as $review)
                @component('tour::components.review-card', ['review' => $review])
                @endcomponent
            @endforeach
        </div>
        <div class=" gap-2 flex">
            <div id="prevTestimonials" class="cursor-pointer">
                <svg class="h-8 w-8 text-main  shadow-2xl transition-all" viewBox="0 0 24 24" fill="none"
            ...
            <div id="nextTestimonials" class="cursor-pointer md:mb-2">
                <svg class="h-8 w-8 text-main  transition-all" viewBox="0 0 24 24" fill="none" stroke="currentColor"
