<a href="{{ route('best-destination.show', ['location' => $location->slug]) }}"
    ...
    <div class="absolute bottom-[10%] left-1/2 transform -translate-x-1/2 w-full">
        <h3 class="text-[22px] text-white font-medium text-center uppercase tracking-wide ">{{ $location->name }}</h3>
    </div>
</a>
