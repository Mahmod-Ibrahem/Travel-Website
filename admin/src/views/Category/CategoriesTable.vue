        ...
        <table class="table_tag ">
            <thead>
                <tr>
                    ...
                    <TableHeadingCell class="border-b-2 p-2 text-left" field="title" :sort-field="sortField"
                        :sort-direction="sortDirection">

                        Type
                    </TableHeadingCell>
                    <TableHeadingCell class="border-b-2 p-2 text-left" field="quantity" :sort-field="sortField"
                        :sort-direction="sortDirection">

                        Name
                    </TableHeadingCell>
                    <TableHeadingCell class="border-b-2 p-2 text-left" field="price" :sort-field="sortField"
                        :sort-direction="sortDirection">
                        Image
                    </TableHeadingCell>
