    ...
    <div class="managmenet_container">
        ...
        <table class="table_tag">
            ...
            <tr>
                ...
                <TableHeadingCell  class="border-b-2 p-2 text-left" field="key"
                                  >

                    Key
                </TableHeadingCell>
                <TableHeadingCell  class="border-b-2 p-2 text-left" field="value"
                                  >
                    Value
                </TableHeadingCell>
            ...
            <tr v-for="(setting, index) of settings.data">
                <td class="border-b p-2 ">{{ setting.id }}</td>
                            ...
                            <MenuItems
                                ...
                                <div class="px-1 py-1">
                                    <MenuItem v-slot="{ active }">
                                        <RouterLink :to="{ name: 'app.settings.edit', params: { id: setting.id } }" :class="[
