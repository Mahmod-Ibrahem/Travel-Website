        ...
        <div class="max-w-7xl mx-auto mb-6">
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 v-if="!loading" class="text-2xl md:text-3xl font-bold text-slate-800">
                    {{ city.id ? `Update City` : 'Create New City' }}
                </h1>
            </div>
            <p v-if="city.id && !loading" class="text-slate-500 ml-13">
                Editing: <span class="font-medium text-indigo-600">{{ city.name }}</span>
            </p>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <form v-else @submit.prevent="onSubmit">
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <CustomInput v-model="city.name" :errors="errors.name" placeholder="Enter City Name" />
                        </div>
                        ...
                        <div>
                            ...
                            <CustomInput type="file" @change="file => city.image = file" :errors="errors.image" />
                        </div>
                    </div>
                </div>
                ...
                flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-3 mt-6">
                    <RouterLink :to="{ name: 'app.cities' }" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 
